...
src_data=/other/data/norwegian_resources/audio/metadata
...
# data preparation
# parts: 1. train vs test vs dev  datasets
...
if [ $stage -le 1 ]; then
  ...
  ./local/norwegian_data_prep.sh $src_data data/train data/dev data/test
  # for part in train dev test; do
  #   # use underscore-separated names in data directories.
  #   #local/data_prep.sh $data/LibriSpeech/$part data/$(echo $part | sed s/-/_/g)
  #   local/norwegian_data_prep.sh $src_data ${part}_set data/$part
  # done
